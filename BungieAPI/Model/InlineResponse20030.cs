...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20030 :  IEquatable<InlineResponse20030>, IValidatableObject
    {
        ...
        public InlineResponse20030(List<EntitiesEntityActionResult> response = default(List<EntitiesEntityActionResult>), ExceptionsPlatformErrorCodes errorCode = default(ExceptionsPlatformErrorCodes), int? throttleSeconds = default(int?), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
