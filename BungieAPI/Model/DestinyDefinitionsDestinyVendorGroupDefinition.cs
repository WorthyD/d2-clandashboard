...
namespace BungieAPI.Model
{
    ...
    public partial class DestinyDefinitionsDestinyVendorGroupDefinition :  IEquatable<DestinyDefinitionsDestinyVendorGroupDefinition>, IValidatableObject
    {
        ...
        public DestinyDefinitionsDestinyVendorGroupDefinition(int? Order = default(int?), string CategoryName = default(string), uint? Hash = default(uint?), int? Index = default(int?), bool? Redacted = default(bool?))
        {
            this.Order = Order;
