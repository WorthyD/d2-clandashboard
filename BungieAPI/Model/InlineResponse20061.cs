...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20061 :  IEquatable<InlineResponse20061>, IValidatableObject
    {
        ...
        public InlineResponse20061(CommunityCommunityLiveStatus response = default(CommunityCommunityLiveStatus), ExceptionsPlatformErrorCodes errorCode = default(ExceptionsPlatformErrorCodes), int? throttleSeconds = default(int?), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
        ...
        public CommunityCommunityLiveStatus Response { get; set; }
