...
namespace BungieAPI.Model
{
    ...
    public partial class DestinyDefinitionsDestinyInventoryItemDefinition :  IEquatable<DestinyDefinitionsDestinyInventoryItemDefinition>, IValidatableObject
    {
        ...
        public DestinyDefinitionsDestinyInventoryItemDefinition(DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition displayProperties = default(DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition), int? collectibleHash = default(int?), string secondaryIcon = default(string), string secondaryOverlay = default(string), string secondarySpecial = default(string), Object backgroundColor = default(Object), string screenshot = default(string), string itemTypeDisplayName = default(string), string uiItemDisplayStyle = default(string), string itemTypeAndTierDisplayName = default(string), string displaySource = default(string), string tooltipStyle = default(string), Object action = default(Object), Object inventory = default(Object), Object setData = default(Object), Object stats = default(Object), int? emblemObjectiveHash = default(int?), Object equippingBlock = default(Object), Object translationBlock = default(Object), Object preview = default(Object), Object quality = default(Object), Object value = default(Object), Object sourceData = default(Object), Object objectives = default(Object), Object plug = default(Object), Object gearset = default(Object), Object sack = default(Object), Object sockets = default(Object), Object summary = default(Object), Object talentGrid = default(Object), List<DestinyDefinitionsDestinyItemInvestmentStatDefinition> investmentStats = default(List<DestinyDefinitionsDestinyItemInvestmentStatDefinition>), List<DestinyDefinitionsDestinyItemPerkEntryDefinition> perks = default(List<DestinyDefinitionsDestinyItemPerkEntryDefinition>), int? loreHash = default(int?), int? summaryItemHash = default(int?), List<DestinyDefinitionsAnimationsDestinyAnimationReference> animations = default(List<DestinyDefinitionsAnimationsDestinyAnimationReference>), bool? allowActions = default(bool?), List<LinksHyperlinkReference> links = default(List<LinksHyperlinkReference>), bool? doesPostmasterPullHaveSideEffects = default(bool?), bool? nonTransferrable = default(bool?), List<int?> itemCategoryHashes = default(List<int?>), Object specialItemType = default(Object), Object itemType = default(Object), Object itemSubType = default(Object), Object classType = default(Object), bool? equippable = default(bool?), List<int?> damageTypeHashes = default(List<int?>), List<DestinyDamageType> damageTypes = default(List<DestinyDamageType>), Object defaultDamageType = default(Object), int? defaultDamageTypeHash = default(int?), int? hash = default(int?), int? index = default(int?), bool? redacted = default(bool?))
        {
        ...
        public Object SpecialItemType { get; set; }
        ...
        public Object ItemSubType { get; set; }
        ...
        public Object DefaultDamageType { get; set; }
