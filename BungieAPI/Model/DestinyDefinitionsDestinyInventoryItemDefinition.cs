...
namespace BungieAPI.Model
{
    ...
    public partial class DestinyDefinitionsDestinyInventoryItemDefinition :  IEquatable<DestinyDefinitionsDestinyInventoryItemDefinition>, IValidatableObject
    {
        ...
        public DestinyDefinitionsDestinyInventoryItemDefinition(DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition DisplayProperties = default(DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition), uint? CollectibleHash = default(uint?), string SecondaryIcon = default(string), string SecondaryOverlay = default(string), string SecondarySpecial = default(string), DestinyMiscDestinyColor BackgroundColor = default(DestinyMiscDestinyColor), string Screenshot = default(string), string ItemTypeDisplayName = default(string), string UiItemDisplayStyle = default(string), string ItemTypeAndTierDisplayName = default(string), string DisplaySource = default(string), string TooltipStyle = default(string), DestinyDefinitionsDestinyItemActionBlockDefinition Action = default(DestinyDefinitionsDestinyItemActionBlockDefinition), DestinyDefinitionsDestinyItemInventoryBlockDefinition Inventory = default(DestinyDefinitionsDestinyItemInventoryBlockDefinition), DestinyDefinitionsDestinyItemSetBlockDefinition SetData = default(DestinyDefinitionsDestinyItemSetBlockDefinition), DestinyDefinitionsDestinyItemStatBlockDefinition Stats = default(DestinyDefinitionsDestinyItemStatBlockDefinition), uint? EmblemObjectiveHash = default(uint?), DestinyDefinitionsDestinyEquippingBlockDefinition EquippingBlock = default(DestinyDefinitionsDestinyEquippingBlockDefinition), DestinyDefinitionsDestinyItemTranslationBlockDefinition TranslationBlock = default(DestinyDefinitionsDestinyItemTranslationBlockDefinition), DestinyDefinitionsDestinyItemPreviewBlockDefinition Preview = default(DestinyDefinitionsDestinyItemPreviewBlockDefinition), DestinyDefinitionsDestinyItemQualityBlockDefinition Quality = default(DestinyDefinitionsDestinyItemQualityBlockDefinition), DestinyDefinitionsDestinyItemValueBlockDefinition Value = default(DestinyDefinitionsDestinyItemValueBlockDefinition), DestinyDefinitionsDestinyItemSourceBlockDefinition SourceData = default(DestinyDefinitionsDestinyItemSourceBlockDefinition), DestinyDefinitionsDestinyItemObjectiveBlockDefinition Objectives = default(DestinyDefinitionsDestinyItemObjectiveBlockDefinition), DestinyDefinitionsItemsDestinyItemPlugDefinition Plug = default(DestinyDefinitionsItemsDestinyItemPlugDefinition), DestinyDefinitionsDestinyItemGearsetBlockDefinition Gearset = default(DestinyDefinitionsDestinyItemGearsetBlockDefinition), DestinyDefinitionsDestinyItemSackBlockDefinition Sack = default(DestinyDefinitionsDestinyItemSackBlockDefinition), DestinyDefinitionsDestinyItemSocketBlockDefinition Sockets = default(DestinyDefinitionsDestinyItemSocketBlockDefinition), DestinyDefinitionsDestinyItemSummaryBlockDefinition Summary = default(DestinyDefinitionsDestinyItemSummaryBlockDefinition), DestinyDefinitionsDestinyItemTalentGridBlockDefinition TalentGrid = default(DestinyDefinitionsDestinyItemTalentGridBlockDefinition), List<DestinyDefinitionsDestinyItemInvestmentStatDefinition> InvestmentStats = default(List<DestinyDefinitionsDestinyItemInvestmentStatDefinition>), List<DestinyDefinitionsDestinyItemPerkEntryDefinition> Perks = default(List<DestinyDefinitionsDestinyItemPerkEntryDefinition>), uint? LoreHash = default(uint?), uint? SummaryItemHash = default(uint?), List<DestinyDefinitionsAnimationsDestinyAnimationReference> Animations = default(List<DestinyDefinitionsAnimationsDestinyAnimationReference>), bool? AllowActions = default(bool?), List<LinksHyperlinkReference> Links = default(List<LinksHyperlinkReference>), bool? DoesPostmasterPullHaveSideEffects = default(bool?), bool? NonTransferrable = default(bool?), List<uint?> ItemCategoryHashes = default(List<uint?>), DestinySpecialItemType SpecialItemType = default(DestinySpecialItemType), DestinyDestinyItemType ItemType = default(DestinyDestinyItemType), DestinyDestinyItemSubType ItemSubType = default(DestinyDestinyItemSubType), DestinyDestinyClass ClassType = default(DestinyDestinyClass), bool? Equippable = default(bool?), List<uint?> DamageTypeHashes = default(List<uint?>), List<DestinyDamageType> DamageTypes = default(List<DestinyDamageType>), DestinyDamageType DefaultDamageType = default(DestinyDamageType), uint? DefaultDamageTypeHash = default(uint?), uint? Hash = default(uint?), int? Index = default(int?), bool? Redacted = default(bool?))
        {
        ...
        public DestinySpecialItemType SpecialItemType { get; set; }
        ...
        public DestinyDestinyItemType ItemType { get; set; }
        ...
        public DestinyDestinyItemSubType ItemSubType { get; set; }
        ...
        public List<DestinyDamageType> DamageTypes { get; set; }
        ...
        public DestinyDamageType DefaultDamageType { get; set; }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DoesPostmasterPullHaveSideEffects != null)
                    hashCode = hashCode * 59 + this.DoesPostmasterPullHaveSideEffects.GetHashCode();
                if (this.NonTransferrable != null)
