...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse2006 :  IEquatable<InlineResponse2006>, IValidatableObject
    {
        ...
        public InlineResponse2006(List<PartnershipsPublicPartnershipDetail> Response = default(List<PartnershipsPublicPartnershipDetail>), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>), string DetailedErrorTrace = default(string))
        {
        ...
        public List<PartnershipsPublicPartnershipDetail> Response { get; set; }
