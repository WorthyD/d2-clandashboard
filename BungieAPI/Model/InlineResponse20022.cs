...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20022 :  IEquatable<InlineResponse20022>, IValidatableObject
    {
        ...
        public InlineResponse20022(GroupsV2GroupResponse Response = default(GroupsV2GroupResponse), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>), string DetailedErrorTrace = default(string))
        {
