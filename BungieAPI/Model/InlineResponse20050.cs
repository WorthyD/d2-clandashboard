...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20050 :  IEquatable<InlineResponse20050>, IValidatableObject
    {
        ...
        public InlineResponse20050(DestinyDefinitionsDestinyEntitySearchResult Response = default(DestinyDefinitionsDestinyEntitySearchResult), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>), string DetailedErrorTrace = default(string))
        {
