...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20025 :  IEquatable<InlineResponse20025>, IValidatableObject
    {
        ...
        public InlineResponse20025(SearchResultOfGroupMember response = default(SearchResultOfGroupMember), ExceptionsPlatformErrorCodes errorCode = default(ExceptionsPlatformErrorCodes), int? throttleSeconds = default(int?), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
