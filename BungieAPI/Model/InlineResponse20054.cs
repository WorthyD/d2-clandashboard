...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20054 :  IEquatable<InlineResponse20054>, IValidatableObject
    {
        ...
        public InlineResponse20054(DestinyHistoricalStatsDestinyHistoricalWeaponStatsData response = default(DestinyHistoricalStatsDestinyHistoricalWeaponStatsData), ExceptionsPlatformErrorCodes errorCode = default(ExceptionsPlatformErrorCodes), int? throttleSeconds = default(int?), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
