...
namespace BungieAPI.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SearchResultOfCommunityLiveStatus :  IEquatable<SearchResultOfCommunityLiveStatus>, IValidatableObject
    {
        /// <summary>
        ...
        public List<CommunityCommunityLiveStatus> Results { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchResultOfCommunityLiveStatus {\n");
        ...
        {
            return this.Equals(input as SearchResultOfCommunityLiveStatus);
        }

        /// <summary>
        /// Returns true if SearchResultOfCommunityLiveStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchResultOfCommunityLiveStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchResultOfCommunityLiveStatus input)
        {
            if (input == null)
                return false;
