...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20057 :  IEquatable<InlineResponse20057>, IValidatableObject
    {
        ...
        public InlineResponse20057(Dictionary<string, DestinyMilestonesDestinyPublicMilestone> response = default(Dictionary<string, DestinyMilestonesDestinyPublicMilestone>), ExceptionsPlatformErrorCodes errorCode = default(ExceptionsPlatformErrorCodes), int? throttleSeconds = default(int?), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
