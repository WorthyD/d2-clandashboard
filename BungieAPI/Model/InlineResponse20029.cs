...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20029 :  IEquatable<InlineResponse20029>, IValidatableObject
    {
        ...
        public InlineResponse20029(SearchResultOfGroupMemberApplication response = default(SearchResultOfGroupMemberApplication), ExceptionsPlatformErrorCodes errorCode = default(ExceptionsPlatformErrorCodes), int? throttleSeconds = default(int?), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
