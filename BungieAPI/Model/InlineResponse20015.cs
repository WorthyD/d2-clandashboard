...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20015 :  IEquatable<InlineResponse20015>, IValidatableObject
    {
        ...
        public InlineResponse20015(List<ForumForumRecruitmentDetail> Response = default(List<ForumForumRecruitmentDetail>), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>), string DetailedErrorTrace = default(string))
        {
