...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20026 :  IEquatable<InlineResponse20026>, IValidatableObject
    {
        ...
        public InlineResponse20026(GroupsV2GroupMemberLeaveResult Response = default(GroupsV2GroupMemberLeaveResult), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>), string DetailedErrorTrace = default(string))
        {
