...
namespace BungieAPI.Model
{
    ...
    public partial class DictionaryComponentResponseOfuint32AndDestinyItemPlugComponent :  IEquatable<DictionaryComponentResponseOfuint32AndDestinyItemPlugComponent>, IValidatableObject
    {
        ...
        public DictionaryComponentResponseOfuint32AndDestinyItemPlugComponent(Dictionary<string, DestinyComponentsItemsDestinyItemPlugComponent> Data = default(Dictionary<string, DestinyComponentsItemsDestinyItemPlugComponent>), ComponentsComponentPrivacySetting Privacy = default(ComponentsComponentPrivacySetting))
        {
            this.Data = Data;
