...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20018 :  IEquatable<InlineResponse20018>, IValidatableObject
    {
        ...
        public InlineResponse20018(bool? response = default(bool?), ExceptionsPlatformErrorCodes errorCode = default(ExceptionsPlatformErrorCodes), int? throttleSeconds = default(int?), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
