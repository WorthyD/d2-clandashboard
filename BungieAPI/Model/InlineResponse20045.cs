...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20045 :  IEquatable<InlineResponse20045>, IValidatableObject
    {
        ...
        public InlineResponse20045(DestinyResponsesDestinyItemChangeResponse response = default(DestinyResponsesDestinyItemChangeResponse), ExceptionsPlatformErrorCodes errorCode = default(ExceptionsPlatformErrorCodes), int? throttleSeconds = default(int?), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
