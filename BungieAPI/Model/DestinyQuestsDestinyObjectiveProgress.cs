...
namespace BungieAPI.Model
{
    ...
    public partial class DestinyQuestsDestinyObjectiveProgress :  IEquatable<DestinyQuestsDestinyObjectiveProgress>, IValidatableObject
    {
        ...
        public DestinyQuestsDestinyObjectiveProgress(uint? ObjectiveHash = default(uint?), uint? DestinationHash = default(uint?), uint? ActivityHash = default(uint?), int? Progress = default(int?), int? CompletionValue = default(int?), bool? Complete = default(bool?), bool? Visible = default(bool?))
        {
