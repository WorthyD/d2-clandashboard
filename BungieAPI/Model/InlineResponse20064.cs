...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20064 :  IEquatable<InlineResponse20064>, IValidatableObject
    {
        ...
        public InlineResponse20064(TrendingTrendingDetail response = default(TrendingTrendingDetail), ExceptionsPlatformErrorCodes errorCode = default(ExceptionsPlatformErrorCodes), int? throttleSeconds = default(int?), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
