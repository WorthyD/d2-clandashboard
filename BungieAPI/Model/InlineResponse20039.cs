...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20039 :  IEquatable<InlineResponse20039>, IValidatableObject
    {
        ...
        public InlineResponse20039(DestinyMilestonesDestinyMilestone response = default(DestinyMilestonesDestinyMilestone), ExceptionsPlatformErrorCodes errorCode = default(ExceptionsPlatformErrorCodes), int? throttleSeconds = default(int?), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
