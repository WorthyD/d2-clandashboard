...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20033 :  IEquatable<InlineResponse20033>, IValidatableObject
    {
        ...
        public InlineResponse20033(DestinyConfigDestinyManifest response = default(DestinyConfigDestinyManifest), ExceptionsPlatformErrorCodes errorCode = default(ExceptionsPlatformErrorCodes), int? throttleSeconds = default(int?), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
