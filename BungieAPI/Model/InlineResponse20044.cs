...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20044 :  IEquatable<InlineResponse20044>, IValidatableObject
    {
        ...
        public InlineResponse20044(DestinyDestinyEquipItemResults Response = default(DestinyDestinyEquipItemResults), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>), string DetailedErrorTrace = default(string))
        {
