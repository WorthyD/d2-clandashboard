...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20069 :  IEquatable<InlineResponse20069>, IValidatableObject
    {
        ...
        public InlineResponse20069(List<GlobalAlert> Response = default(List<GlobalAlert>), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>), string DetailedErrorTrace = default(string))
        {
