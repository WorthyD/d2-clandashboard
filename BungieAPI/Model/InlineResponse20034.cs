...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20034 :  IEquatable<InlineResponse20034>, IValidatableObject
    {
        ...
        public InlineResponse20034(DestinyDefinitionsDestinyDefinition Response = default(DestinyDefinitionsDestinyDefinition), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>), string DetailedErrorTrace = default(string))
        {
