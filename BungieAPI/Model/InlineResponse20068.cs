...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20068 :  IEquatable<InlineResponse20068>, IValidatableObject
    {
        ...
        public InlineResponse20068(CommonModelsCoreSettingsConfiguration response = default(CommonModelsCoreSettingsConfiguration), ExceptionsPlatformErrorCodes errorCode = default(ExceptionsPlatformErrorCodes), int? throttleSeconds = default(int?), string errorStatus = default(string), string message = default(string), Dictionary<string, string> messageData = default(Dictionary<string, string>), string detailedErrorTrace = default(string))
        {
