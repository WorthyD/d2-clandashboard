...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20031 :  IEquatable<InlineResponse20031>, IValidatableObject
    {
        ...
        public InlineResponse20031(GroupsV2GroupMembershipSearchResponse Response = default(GroupsV2GroupMembershipSearchResponse), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>), string DetailedErrorTrace = default(string))
        {
