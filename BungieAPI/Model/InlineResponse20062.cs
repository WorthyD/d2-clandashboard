...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20062 :  IEquatable<InlineResponse20062>, IValidatableObject
    {
        ...
        public InlineResponse20062(TrendingTrendingCategories Response = default(TrendingTrendingCategories), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>), string DetailedErrorTrace = default(string))
        {
