...
namespace BungieAPI.Model
{
    ...
    public partial class DestinyEntitiesItemsDestinyItemSocketState :  IEquatable<DestinyEntitiesItemsDestinyItemSocketState>, IValidatableObject
    {
        ...
        public DestinyEntitiesItemsDestinyItemSocketState(uint? PlugHash = default(uint?), bool? IsEnabled = default(bool?), bool? IsVisible = default(bool?), List<int?> EnableFailIndexes = default(List<int?>), List<uint?> ReusablePlugHashes = default(List<uint?>), List<DestinyQuestsDestinyObjectiveProgress> PlugObjectives = default(List<DestinyQuestsDestinyObjectiveProgress>), List<DestinySocketsDestinyItemPlug> ReusablePlugs = default(List<DestinySocketsDestinyItemPlug>))
        {
