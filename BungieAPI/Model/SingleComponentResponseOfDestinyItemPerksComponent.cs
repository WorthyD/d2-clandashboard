...
namespace BungieAPI.Model
{
    ...
    public partial class SingleComponentResponseOfDestinyItemPerksComponent :  IEquatable<SingleComponentResponseOfDestinyItemPerksComponent>, IValidatableObject
    {
        ...
        public SingleComponentResponseOfDestinyItemPerksComponent(DestinyEntitiesItemsDestinyItemPerksComponent data = default(DestinyEntitiesItemsDestinyItemPerksComponent), ComponentsComponentPrivacySetting privacy = default(ComponentsComponentPrivacySetting))
        {
            this.Data = data;
