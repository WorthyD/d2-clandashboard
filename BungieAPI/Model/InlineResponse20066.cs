...
namespace BungieAPI.Model
{
    ...
    public partial class InlineResponse20066 :  IEquatable<InlineResponse20066>, IValidatableObject
    {
        ...
        public InlineResponse20066(SearchResultOfFireteamResponse Response = default(SearchResultOfFireteamResponse), ExceptionsPlatformErrorCodes ErrorCode = default(ExceptionsPlatformErrorCodes), int? ThrottleSeconds = default(int?), string ErrorStatus = default(string), string Message = default(string), Dictionary<string, string> MessageData = default(Dictionary<string, string>), string DetailedErrorTrace = default(string))
        {
