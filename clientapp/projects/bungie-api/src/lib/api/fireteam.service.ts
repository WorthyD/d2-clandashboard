...
export class FireteamService {
     ...
     */
    public fireteamGetActivePrivateClanFireteamCount(groupId: number, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse20021>;
    public fireteamGetActivePrivateClanFireteamCount(groupId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse20021>>;
    public fireteamGetActivePrivateClanFireteamCount(groupId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse20021>>;
    public fireteamGetActivePrivateClanFireteamCount(groupId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<InlineResponse20021>(`${this.configuration.basePath}/Fireteam/Clan/${encodeURIComponent(String(groupId))}/ActiveCount/`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fireteamGetAvailableClanFireteams(activityType: number, dateRange: number, groupId: number, page: number, platform: number, publicOnly: number, slotFilter: number, langFilter?: string, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse20063>;
    public fireteamGetAvailableClanFireteams(activityType: number, dateRange: number, groupId: number, page: number, platform: number, publicOnly: number, slotFilter: number, langFilter?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse20063>>;
    public fireteamGetAvailableClanFireteams(activityType: number, dateRange: number, groupId: number, page: number, platform: number, publicOnly: number, slotFilter: number, langFilter?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse20063>>;
    public fireteamGetAvailableClanFireteams(activityType: number, dateRange: number, groupId: number, page: number, platform: number, publicOnly: number, slotFilter: number, langFilter?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<InlineResponse20063>(`${this.configuration.basePath}/Fireteam/Clan/${encodeURIComponent(String(groupId))}/Available/${encodeURIComponent(String(platform))}/${encodeURIComponent(String(activityType))}/${encodeURIComponent(String(dateRange))}/${encodeURIComponent(String(slotFilter))}/${encodeURIComponent(String(publicOnly))}/${encodeURIComponent(String(page))}/`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fireteamGetClanFireteam(fireteamId: number, groupId: number, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse20065>;
    public fireteamGetClanFireteam(fireteamId: number, groupId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse20065>>;
    public fireteamGetClanFireteam(fireteamId: number, groupId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse20065>>;
    public fireteamGetClanFireteam(fireteamId: number, groupId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<InlineResponse20065>(`${this.configuration.basePath}/Fireteam/Clan/${encodeURIComponent(String(groupId))}/Summary/${encodeURIComponent(String(fireteamId))}/`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fireteamGetMyClanFireteams(groupId: number, includeClosed: boolean, page: number, platform: number, groupFilter?: boolean, langFilter?: string, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse20064>;
    public fireteamGetMyClanFireteams(groupId: number, includeClosed: boolean, page: number, platform: number, groupFilter?: boolean, langFilter?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse20064>>;
    public fireteamGetMyClanFireteams(groupId: number, includeClosed: boolean, page: number, platform: number, groupFilter?: boolean, langFilter?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse20064>>;
    public fireteamGetMyClanFireteams(groupId: number, includeClosed: boolean, page: number, platform: number, groupFilter?: boolean, langFilter?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<InlineResponse20064>(`${this.configuration.basePath}/Fireteam/Clan/${encodeURIComponent(String(groupId))}/My/${encodeURIComponent(String(platform))}/${encodeURIComponent(String(includeClosed))}/${encodeURIComponent(String(page))}/`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public fireteamSearchPublicAvailableClanFireteams(activityType: number, dateRange: number, page: number, platform: number, slotFilter: number, langFilter?: string, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse20063>;
    public fireteamSearchPublicAvailableClanFireteams(activityType: number, dateRange: number, page: number, platform: number, slotFilter: number, langFilter?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse20063>>;
    public fireteamSearchPublicAvailableClanFireteams(activityType: number, dateRange: number, page: number, platform: number, slotFilter: number, langFilter?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse20063>>;
    public fireteamSearchPublicAvailableClanFireteams(activityType: number, dateRange: number, page: number, platform: number, slotFilter: number, langFilter?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<InlineResponse20063>(`${this.configuration.basePath}/Fireteam/Search/Available/${encodeURIComponent(String(platform))}/${encodeURIComponent(String(activityType))}/${encodeURIComponent(String(dateRange))}/${encodeURIComponent(String(slotFilter))}/${encodeURIComponent(String(page))}/`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
